...
<div id="main">
  ...
  <div id="content">
        ...
        <div class="right-bot-corner">
          <div class="left-bot-corner">
            <div class="inner">
              <div class="box1 alt">
                <div class="inner">
                  <h4><b>Offre</b> Mobile</h4>
                  <p class="p0">Soyez Mobile et communiquez en toute liberté. Postpayé ou prépayé, profitez pleinement de nos offres, nos promos, nos services et nos packs.</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="indent">
      <div class="wrapper">
        <div class="col-1">
          <h3><b>Découvrez</b> Nos Offre Mobile</h3>
            <ul class="list" style="width: 65%;float: left;">
                <?php
                require_once 'scripts/connexion.php';
                
                $sql = mysql_query("select * from tt_articles where art_cat ='1' order by art_date,art_id desc");
